...
namespace TFSManager.Core.WinForms.Controls
{
    public class TransparentRichTextBox : RichTextBox
    {
        ...
        #endregion transparency support
        ...
        private void FixSelectionStart()
        {
//            if (this.SelectionStart >= this.Text.Length)
//            {
//                this.SelectionStart = this.Text.Length == 0 ? 0 : this.Text.Length - 1;
//            }
        }
        ...
        public void InsertLink(string text, string hyperlink, int position)
        {
            ...
            this.SelectionStart = position;
            this.SelectedRtf = @"{\rtf1\ansi\ansicpg" + System.Text.Encoding.Default.CodePage + " " + text + @"\v #" + hyperlink + @"\v0}";
